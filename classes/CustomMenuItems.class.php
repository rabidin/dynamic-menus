<?php 
/**
 * From: Jonathan Daggerhart, PHP and JavaScript developer from Western North Carolina
 * Original instructions:
 * https://www.daggerhart.com/dynamically-add-item-to-wordpress-menus/ This class is for creating and managing dynamic menu items in a WordPress
 *
 * Updated in GitHub
...
class CustomMenuItems {
	...
	static public function add_item( $menu_slug, $title, $url, $order = 0, $parent = 0, $ID = null, $classes = array() ){
		$instance = CustomMenuItems::get_instance();
